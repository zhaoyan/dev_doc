...
\begin{itemize}
	\item Some common algorithms implementation: insert sort, rotate, nth\_element. partition, remove(duplicate), sort. reverse. reverse matrix. binary-search, split, views::chunk\_by, views::slide.
	...
	\item index, Make use of index information, an example is leetcode 448: Given an array nums of n integers where nums[i] is in the range [1, n], return an array of all the integers in the range [1, n] that do not appear in nums. Example 1: Input: nums = [4,3,2,7,8,2,3,1]Output: [5,6]
	
	Another famous example to use index information is  https://www.geeksforgeeks.org/counting-sort/
	...
	\item Use other auxiliary DS, such as, map, set or hash\_map.  They can be used as count and sort.  how many unorder?  0316.Remove Duplicate Letters
