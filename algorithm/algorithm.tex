...
\begin{itemize}
	\item What atomic operation is?
	
	\item define all necessary state in one atomic operation? what need? what change? 
	
	\item Init condition and end condition? 
...
\begin{itemize}
	...
	\item Prefer to use std container, algorithm and views, especially views::
...
\end{enumerate}
	...
	\item tire tree, just multi-branch tree, use pointer array, and is\_leaf. 
