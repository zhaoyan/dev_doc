...
\section{basic command}
	...
	\begin{center}
		...
		\hline
		b/e of document &  <A-f>(begin)  & 1G(I,to insert mode), G(A)  \\
        ...
        above, next line &<A-p> and <A-o> & O and o\\
         ...
         \hline match next character & UU, RR   & fx, Fx \\
        ...
        \hline
        scroll one  page &  <A-r> and <A-y>  & ctrl+b and  ctrl+f    \\
        
        \hline 		  
        scroll one line &  <A-u> and <A-t>  & ctrl+e and ctrl+y \\
        
         \hline 		  
        move line to m/t/b & <A-z> <A-q>  & zz zt zb \\
