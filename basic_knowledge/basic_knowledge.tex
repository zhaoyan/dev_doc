...
\item regex in search command:
		\begin{enumerate}
                ...
                \item vimgrep is slow, You can use :grep to use external grep to search, it's much faster. But in neovim, you have to use -r and --color=never flag. Otherwise, result includes color code and can't be shown properly in neovim.
