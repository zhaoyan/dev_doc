...
\begin{itemize}
		...
		\item gk and gk will go to next line in wraped mode. 
\end{itemize}
...
\end{verbatim}
\end{itemize}
\subsection{pyclewn and vimgdb}
\begin{itemize}
\end{itemize}

\subsection{Tagbar and cscope}
\begin{itemize}
...
\item You don't need run any command. Just add it to .vimrc or use :TagbarToggle directly.
\begin{verbatim}
nmap <F8> :TagbarToggle<CR>
\end{verbatim}

\begin{itemize}
\item cscope is Another application which you can download or install it. 
