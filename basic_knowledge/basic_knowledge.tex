...
\item \linuxcommand{:lv word \%} will search all word in current file. It will show all the result in position list. 
		\begin{enumerate}
				...
				\item both \# and /, you can press F4 to toggle highlight research result. 
				...
				\item Another subtopics is search scopes.
						\begin{enumerate}
								...
								\item For :lv, you can use **/*.cpp to search all .cpp files recursively. You also can input complex regex manually, So :lv is more flexible than vv. vv is more convenient than :lv.  
						\end{enumerate}
		\end{enumerate}		
...
\begin{enumerate}
		...
		\item Any time you edit a source code, run \linuxcommand{:!cscope -Rbq}, then run :cs add cs<tab>. add cscope.out file. Then you can use cscope command to jump. Detail commands can be found in cscope section.
