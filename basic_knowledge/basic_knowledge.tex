...
\section{putty}
 ...
 \textbf{In putty, highlight is just copy and right click is just paste. } 
  ...
  in github, there is solarized\_dark.reg, go to your reg editor, find [HKEY\_CURRENT\_USER\Software\SimonTatham\PuTTY\Sessions\192.168.0.182], then export , 
