...
\end{lstlisting}
		...
		\includegraphics[scale=0.6]{pics/check.png}
...
\end{lstlisting}
	...
	\includegraphics[scale=0.6]{pics/revision.png}
...
\subsubsection{exmaples in company}
\begin{itemize}
	
	\item git apply --whitespace=warn patchname.patch 
...
\item how to port to certain release?
\begin{lstlisting}
	...
	2) git pull // this command will pull new content.  The first time you checkout, you don't need to run it. but after a few days, you need to run it to keep track the remote. 
...
\item git difftool HEAD, check current working files with HEAD
...
\item list all you local branch. 
\begin{lstlisting}
