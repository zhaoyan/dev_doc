...
\subsection{people}
	...
	investiture inauguration coronation
...
\subsection{sport}
\begin{itemize}
\item offsite dribble score a goal(basket) tackle, sliding tackle, backboard, sideline, endline, foul
referee umpire 
\end{itemize}

\subsection{art and culture}
\begin{itemize}
	\item craft, craftman, craftmanship, artifact
...
mumps, tonsillitis, migraine, measles, asthma
eczema, insomnia, diarrhea, 

vomit, sneeze, resuscitate, ointment, adhesive tape, antiseptic wipes, syringe, 
stethoscope (endoscope, periscope, oscilloscope, )

sling whiplash sprain, splinter,

paramedic, stretcher, cuff, blood test, scalpel, intensive care unit, ward, 

pediatrics, radiology, neurology, cardiology, orthopedics, pathology, urology, maternity, 
...
\begin{itemize}
	...
	\item orca okra
	odor older aviary ivory cavalry caviar 
	
	\item itinerary literary
	
	\item caramelize shabby shady decorum etiquette vaseline chap obstinate ego ostentatious malice laminate slimy transcend sequel convey convoy
...
\section{mische}
\begin{lstlisting}
mirin glaze teriyaki sake

glossy gross greasy grizzly 

geniuen courageours consulate

undercover agent, plain clothes officeers

poignant vigilant

audacious concentration

stigma stamina stagnate
...
transcent FOMO analysis paralysis

anatomy antonym

subsequent following consecutive succeeding

rough dryskin scaly chapped vaseline 

bystander onlooker 

authentic authentiate  
...
serene tranquil placid chaotic trubulent

luminous radiant 

flucky annotate garrsion 

flucky annotate topography nimble

denote annotate dentonation

ardent zealous apathetic indifferent

benevolent behemoth monolithic 

debunk disprove 

elaborate embellishment flashy

contemplate temple contempt template

disdain scoren contempt toiletry

disruptive innovation divate diverge 
